...
class BubbleUp_Gtmdatalayer_Block_Cart extends BubbleUp_Gtmdatalayer_Block_Json
{
    ...
    */
    ...
    public function generateEventDataCartAdd($products)
    {
        return array(
          "event" => "addToCart",
          "ecommerce" => array(
    ...
    public function generateEventDataCartRemove($products)
    {
        return array(
    ...
    public function harvestDataFromSession($key)
    {
    ...
    public function getCartItemData($lineItem)
    {
