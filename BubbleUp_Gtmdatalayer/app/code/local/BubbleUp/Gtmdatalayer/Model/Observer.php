...
*/
    ...
    function processRelatedProducts($item) {
        if( !$item ) return; // have to be very careful about checking for odd inputs here. Never know how this observer will get triggered, and we REALLY don't want to break add-to-cart!
    ...
    function pushToSession($productData, $sessionDataKey) {
    ...
    function getAttributesToInclude(Varien_Event_Observer $observer) {
    ...
    function getConfigurableAttributeCodes() {
